...
object AutoNfc : BaseHook() {
    ...
    fun initResource(resparam: XC_InitPackageResources.InitPackageResourcesParam) {
        resparam.res.setReplacement("com.miui.tsmclient", "string", "nfc_off_hint", "正在自动开启NFC...")
        resparam.res.setReplacement("com.miui.tsmclient", "string", "immediately_open", "手动开启NFC")
    }
